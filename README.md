...
If you use this work, **please cite the published journal article** instead of the arXiv preprint.
...
This work has now been **peer-reviewed and published** in _Cartography and Geographic Information Science_.
